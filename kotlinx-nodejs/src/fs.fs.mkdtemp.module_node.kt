...
external fun __promisify__(prefix: String, options: fs.`T$31`? = definedExternally): Promise<String>

external fun __promisify__(prefix: String, options: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<String>

external fun __promisify__(prefix: String, options: fs.`T$32`): Promise<Buffer>
