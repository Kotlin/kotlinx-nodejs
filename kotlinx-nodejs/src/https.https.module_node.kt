...
external fun request(options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest
...
external fun request(url: String, options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest

external fun request(url: URL, options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest

external fun get(options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest
...
external fun get(url: String, options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest

external fun get(url: URL, options: RequestOptions /* http.RequestOptions & tls.SecureContextOptions & `T$60` */, callback: (res: IncomingMessage) -> Unit = definedExternally): ClientRequest
