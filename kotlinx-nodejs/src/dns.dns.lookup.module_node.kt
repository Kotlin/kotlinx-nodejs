...
external fun __promisify__(hostname: String, options: dns.LookupOneOptions = definedExternally): Promise<dns.LookupAddress>

external fun __promisify__(hostname: String, options: Number = definedExternally): Promise<dns.LookupAddress>
