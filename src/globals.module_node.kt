...
external interface RequireResolve {
    @nativeInvoke
    operator fun invoke(id: String, options: `T$0` = definedExternally): String
...
external open class Buffer(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "latin1" | "binary" | "hex" */ = definedExternally) : Uint8Array {
    ...
    override fun subarray(begin: Number, end: Number): Buffer
    ...
    override fun entries(): IterableIterator<dynamic /* JsTuple<Number, Number> */>
    ...
    override fun values(): IterableIterator<Number>
